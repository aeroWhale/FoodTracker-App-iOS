...
class MealTableViewController: UITableViewController {
    ...
    */
    ...
    // ▶️ Very imporatant, learn how to use function `prepare(for:sender:)`
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "ShowDetail":
            ...
            // Get destination view controller, which should be a MealViewController
            guard let mealDetailViewController = segue.destination as? MealViewController else {
                fatalError("Unexpected destination: \(segue.destination)")
            }
            
            // Get selected meal cell
            guard let selectedMealCell = sender as? MealTableViewCell else {
                fatalError("Unexpected sender: \(sender)")
            }
            
            // Get index path of the selected meal
            ...
            // Pass the meal data to the object of MealViewController
